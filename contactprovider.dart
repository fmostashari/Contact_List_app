...
class ContactProvider with ChangeNotifier {
  ...
  void toggleFavorite(PersonInfo person) {
    if (person.isFavorite) {
      removeFromFavorite(person);
    } else {
      addToFavorite(person);
    }
  }

  List<PersonInfo> get favoriteContacts {
    return allContacts.where((person) => person.isFavorite).toList();
  }

  void removeFromFavorites(PersonInfo person) {
